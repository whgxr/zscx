...
cmd = "echo 'REDACTED_PASSWORD' | sudo -S bash -c 'cd /vol3/1000/docker/zscx/docker && docker compose up -d --build --force-recreate' 2>&1"
...
if exit_status == 0:
    ...
    stdin2, stdout2, stderr2 = ssh.exec_command("echo 'REDACTED_PASSWORD' | sudo -S docker compose -f /vol3/1000/docker/zscx/docker/docker-compose.yml ps 2>&1")
