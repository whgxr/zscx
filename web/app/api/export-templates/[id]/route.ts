...
const updateTemplateSchema = z.object({
  ...
  documentFileKey: z.string().optional().nullable(),
  spreadsheetFileKey: z.string().optional().nullable(),
  ...
  try {
    ...
    const updatedTemplate = await prisma.exportTemplate.update({
      ...
      data: {
        ...
        ...(data.documentConfig !== undefined && { documentConfig: data.documentConfig as any }),
        ...(data.documentFileKey !== undefined && { documentFileKey: data.documentFileKey }),
        ...(data.spreadsheetFileKey !== undefined && { spreadsheetFileKey: data.spreadsheetFileKey }),
